...
import { FaCheckCircle, FaMapMarkerAlt, FaShieldAlt } from "react-icons/fa";
...
const Ordersummary = () => {
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            setUser(userData);
            // Get product from cart or fallback to d1
            setProduct(cartData.length > 0 ? cartData[0] : productData);
            setLoading(false);
        }
    }, []);
                    ...
                    <div style={{
                        ...
                        <div style={{ flex: 1 }}>
                            ...
                            <div style={{ fontSize: '12px', color: '#878787' }}>
                                Qty: <span style={{ fontWeight: '600', color: '#212121' }}>1</span>
                            </div>
                        </div>
                    </div>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
                            <span style={{ color: '#212121' }}>Price (1 item)</span>
                            <span style={{ color: '#212121' }}>₹{mrp}</span>
                        </div>
                        ...
                        <div style={{
                            ...
                            <span style={{ fontWeight: '700', color: '#212121' }}>₹{sellingPrice}</span>
                        </div>
                    </div>
